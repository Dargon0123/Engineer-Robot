...
#ifndef _MK60DN10_port_cfg_h
#define _MK60DN10_port_cfg_h
...
//      模块通道        端口      可选范围                建议
#define FTM1_CH0_PIN    A13       //A8、A12、B0
#define FTM1_CH1_PIN    A12       //A9、A13、B1
...
#define SPI0_PCS1_PIN   C3        // C3、D4             全部是 ALT2
#define SPI0_PCS2_PIN   C2        // C2、D5             全部都是 ALT2
#define SPI0_PCS3_PIN   C1        // C1、D6             全部都是 AL都T2
