...
//----宏定义OLED引脚----	 
#define  OLED_SCL_PIN	B8
#define  OLED_SDA_PIN	B7
#define  OLED_RST_PIN	B6
#define  OLED_DC_PIN	B5
#define  OLED_CS_PIN	B4
...
//void OLED_Print_Num(uint8 x, uint8 y, uint8 num);  //进行更改函数
